          ...
          <section v-if="current_tab === tabs.FormRequest" class="section">
            ...
            <Spoiler>
              ...
              <div class="ru">
                ...
                <b>Правила:</b>
                <ul>
                  <li>Request отвечает <b>только</b> за валидацию данных, поступающих в контроллер.</li>
                  <li>Request <b>не может</b> использовать другие сущности (в том числе Request).</li>
                </ul>
              </div>
            </Spoiler>
          ...
          <section v-if="current_tab === tabs.Action" class="section">
            ...
            <Spoiler>
              ...
              <div class="ru">
                ...
                <b>Правила:</b>
                <ul>
                  <li>Action состоит из <b>двух публичных методов:</b>
                    <ul>
                      <li><code style="font-size:16px">run()</code> - Содержит весь код, реализующий бизнес-логику Action</li>
                      <li><code style="font-size:16px">authorize()</code> - Содержит проверку доступа пользователя к коду в <code style="font-size:16px">run()</code>. Позволяет вернуть инстанс <code style="font-size:16px">User</code>, доступ к которому можно получить через <code style="font-size:16px">$this->user</code> внутри метода <code style="font-size:16px">run()</code></li>
                    </ul>
                  </li>
                  <li>Action <b>едиственная</b> сущность, которая может использовать Policy.</li>
